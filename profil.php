...
<div class="information block">
    <div class="container">
        <div class="panel panel-primary">
            ...
            <li>
            <span> prenom</span> : <?php echo $data['prenom']?>
             </li>
             <li>
            <span> Nom</span> : <?php echo $data['nom']?>
             </li>
            <li>
            <span>Date de naissance</span> : <?php echo $data['date_de_naissance']?> 
            </li>
            <li>
            <span> Poids</span> : <?php echo $data['poids']?>
             </li>
             <li>
            <span> Taille</span> : <?php echo $data['taille']?>
             </li>
             <li>
            <span> Allérgie</span> : <?php echo $data['allergie']?>
             </li>
             <li>
            <span> Maladie</span> : <?php echo $data['maladie']?>
             </li>
             <li>
            <span> Médecin traitant</span> : <?php echo $data['medecin']?>
             </li>
             </ul>
             <a href="modif_agenda.php" class="btn btn-default">Modifier l'Agenda</a>
            </div>
        </div>
    </div>
</div> 
