			...
			<div class="container" >
                ...
                ?>                <!-- Bloc Inscrition -->
									<form action="inscription_traitement.php" method="post">
										...
										<div class="row">
											...
											<div id="formulaire" class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													...
													<input type="password" name="conf_mdp" id="phone" class="form-control input-md" placeholder="Re-tapez le mot de passe" minlength="8" required>
												</div>
											</div>
										...
										<p class="lead-footer">Vous avez un compte, connectez-vous <a href="connexion.php"><u>ici</u></a></p>
